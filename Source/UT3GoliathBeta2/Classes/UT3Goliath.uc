...
defaultproperties
{
	...
	IdleSound = Sound'UT3GoliathBeta2.Sounds.Engine';
	StartUpSound = Sound'UT3GoliathBeta2.Sounds.EngineStart';
	ShutDownSound = Sound'UT3GoliathBeta2.Sounds.EngineStop';
	
	ImpactDamageSounds(0) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(1) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(2) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(3) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(4) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(5) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ImpactDamageSounds(6) = Sound'UT3GoliathBeta2.Sounds.Impact';
	ExplosionSounds(0) = Sound'UT3GoliathBeta2.Sounds.Explode';
	ExplosionSounds(1) = Sound'UT3GoliathBeta2.Sounds.Explode';
	ExplosionSounds(2) = Sound'UT3GoliathBeta2.Sounds.Explode';
	ExplosionSounds(3) = Sound'UT3GoliathBeta2.Sounds.Explode';
	ExplosionSounds(4) = Sound'UT3GoliathBeta2.Sounds.Explode';
